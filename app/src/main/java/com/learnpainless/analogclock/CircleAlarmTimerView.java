...
package com.nazlcanozturk46.newroom;
...
//            <************************************************>
            ...
            Drawable buttonDrawable = AppCompatResources.getDrawable(getContext(), R.drawable.upscal);
            int left = (int) (mCx - mRadius);
            int top = (int) (getMeasuredHeight() / 2 - mRadius + mCircleStrokeWidth / 2 + mGapBetweenCircleAndLine - mRadius);
            int right = (int) (mCx + mRadius);
            int bottom = (int) ((getMeasuredHeight() / 2 - mRadius + mCircleStrokeWidth / 2 + mGapBetweenCircleAndLine - mRadius) + mRadius);
